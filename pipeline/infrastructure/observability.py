...
class PerformanceMonitor:
    ...
    async def get_performance_summary(
        ...
        async with self._lock:
            ...
            metrics = [
                m for m in metrics
                if datetime.fromtimestamp(m.start_time, timezone.utc) >= since
            ]
...
def performance_monitor(operation_name: str, labels: Optional[Dict[str, str]] = None):
...
class ObservabilityStack:
    ...
    def get_logger(self, name: str, service: Optional[str] = None) -> StructuredLogger:
