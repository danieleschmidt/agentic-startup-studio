...
from pipeline.events.event_bus import get_event_bus, EventType, DomainEvent
...
class QualityCriteria:
    ...
    def validate(self, value: Any) -> bool:
        ...
        try:
            ...
            elif self.criteria_type == QualityCriteriaType.BOOLEAN:
                return self._validate_boolean(value)
            elif self.criteria_type == QualityCriteriaType.RANGE:
                return self._validate_range(value)
            elif self.criteria_type == QualityCriteriaType.PATTERN:
                return self._validate_pattern(value)
            elif self.criteria_type == QualityCriteriaType.CUSTOM:
    ...
    def _validate_threshold(self, value: Union[int, float]) -> bool:
    ...
    def _validate_range(self, value: Union[int, float]) -> bool:
...
class QualityGate:
        ...
        for criteria in self.config.criteria:
            ...
            try:
                ...
                if is_valid:
                    ...
                    if criteria.level == QualityLevel.CRITICAL:
    ...
    def _get_expected_value(self, criteria: QualityCriteria) -> Any:
        ...
        elif criteria.criteria_type == QualityCriteriaType.BOOLEAN:
            return criteria.expected_value
        elif criteria.criteria_type == QualityCriteriaType.RANGE:
            return f"[{criteria.min_value}, {criteria.max_value}]"
        elif criteria.criteria_type == QualityCriteriaType.PATTERN:
    ...
    async def _calculate_overall_result(
        ...
        if critical_failures and self.config.require_all_critical:
            overall_status = QualityGateStatus.FAILED
        elif overall_score < self.config.failure_threshold:
            overall_status = QualityGateStatus.FAILED
