...
class QuantumStateError(QuantumPlannerError):
    ...
    def __init__(self, message: str, task_id: UUID | None = None,
...
class SuperpositionCollapseError(QuantumStateError):
    ...
    def __init__(self, task_id: UUID, amplitudes: dict[str, float] | None = None):
...
class QuantumMeasurementError(QuantumStateError):
    ...
    def __init__(self, message: str, measurement_type: str, task_id: UUID | None = None):
...
class EntanglementError(QuantumPlannerError):
    ...
    def __init__(self, message: str, entanglement_id: UUID | None = None,
...
class SchedulingError(QuantumPlannerError):
    ...
    def __init__(self, message: str, task_count: int | None = None,
...
class DependencyError(QuantumPlannerError):
    ...
    def __init__(self, message: str, task_id: UUID | None = None,
                 dependency_chain: list[UUID] | None = None):
        context = {}
        if task_id:
            context["task_id"] = str(task_id)
        if dependency_chain:
...
class QuantumInterferenceError(QuantumPlannerError):
    ...
    def __init__(self, operation: str, phase_info: dict[str, float] | None = None):
...
class ResourceError(QuantumPlannerError):
    ...
    def __init__(self, message: str, resource_type: str,
                 requested: int | None = None, available: int | None = None):
