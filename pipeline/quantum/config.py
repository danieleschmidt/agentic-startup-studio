...
class ConfigurationLoader:
    ...
    def __init__(self, config_dir: Path | None = None):
        ...
        self.settings: QuantumPlannerSettings | None = None

    def load_configuration(self,
                          environment: Environment | None = None,
                          config_file: Path | None = None) -> QuantumPlannerSettings:
        """
...
_config: QuantumPlannerSettings | None = None
...
def load_configuration(environment: Environment | None = None,
                      config_file: Path | None = None,
                      config_dir: Path | None = None) -> QuantumPlannerSettings:
    """
