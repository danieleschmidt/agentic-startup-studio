...
class CreateIdeaRequest(BaseModel):
    ...
    problem_statement: str | None = Field(None, max_length=1000, description="Problem statement")
    solution_description: str | None = Field(None, max_length=1000, description="Solution description")
    target_market: str | None = Field(None, max_length=500, description="Target market")
...
class UpdateIdeaRequest(BaseModel):
    ...
    problem_statement: str | None = Field(None, max_length=1000)
    solution_description: str | None = Field(None, max_length=1000)
...
class AnalyticsResponse(BaseModel):
    ...
    idea_id: UUID
    analysis_type: str
    market_potential: dict[str, Any] | None = None
    competitive_analysis: dict[str, Any] | None = None
    funding_potential: dict[str, Any] | None = None
...
class SearchRequest(BaseModel):
    ...
    categories: list[IdeaCategory] | None = Field(None, description="Filter by categories")
    statuses: list[IdeaStatus] | None = Field(None, description="Filter by statuses")
    stages: list[PipelineStage] | None = Field(None, description="Filter by stages")
