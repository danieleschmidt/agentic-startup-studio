...
from pipeline.config.settings import DatabaseConfig, get_db_config
...
class IdeaRepository:
    ...
    async def save_idea(self, idea: Idea, correlation_id: str | None = None) -> UUID:
        """
    ...
    async def find_by_id(self, idea_id: UUID) -> Idea | None:
        """
        Find idea by ID.
    ...
    async def find_similar_by_embedding(
        ...
        description: str,
        threshold: float = 0.8,
        exclude_statuses: list[IdeaStatus] | None = None,
        limit: int = 10
    ...
    async def delete_idea(self, idea_id: UUID, user_id: str | None = None) -> bool:
        """
        Delete idea by ID.
...
async def create_idea_repository(config: DatabaseConfig | None = None) -> IdeaRepository:
    """
