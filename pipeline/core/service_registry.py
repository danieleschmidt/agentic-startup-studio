...
class ServiceRegistry:
    ...
    def __init__(self):
        ...
        self._startup_order: list[str] | None = None
        self._shutdown_order: list[str] | None = None
    ...
    def register_service(
        ...
        initialization_args: dict[str, Any] | None = None,
        singleton: bool = True
    ) -> str:
        """
...
async def inject(service_id_or_type: str | type[T]) -> T:
